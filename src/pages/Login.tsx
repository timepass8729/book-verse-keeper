      ...
      <Card className="w-full max-w-md shadow-lg border-book-accent/20">
        <CardHeader className="space-y-2 text-center">
          <div className="flex justify-center">
            <BookOpen className="h-12 w-12 text-book-primary" />
          </div>
          <CardTitle className="text-3xl font-serif text-book-primary">Book Management</CardTitle>
        ...
        <CardFooter className="flex justify-center">
          <p className="text-sm text-book-text/70">
            ...
            <Link to="/signup" className="text-book-primary hover:underline font-medium">
              Sign up
            </Link>
          </p>
        </CardFooter>
